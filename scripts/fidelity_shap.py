...
if __name__ == "__main__":
    ...
    with open(f"../results/{config['dataset']}/importance_scores/shap_seed{seed}.pkl", "rb") as infile:
    ...
    with open(f"../results/{config['dataset']}/shap_fidelity_values_seed{seed}.pkl", "wb") as outfile:
